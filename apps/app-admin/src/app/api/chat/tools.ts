      ...
      case 'completeTask': {
        ...
        if (taskId === 'complete_all_tasks') {
          ...
          if (success) {
            ...
            return JSON.stringify({ success: true, message: `All tasks for ${location} have been marked complete!`, allTasksCompletedForLocation: true, locationCompleted: true, nextAction: 'Please select the condition for this location: [1] Good, [2] Fair, [3] Un-Satisfactory, [4] Un-Observable, [5] Not Applicable. Reply with the number.' })
          }
