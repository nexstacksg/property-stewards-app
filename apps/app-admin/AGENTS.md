...
- PRs: clear summary, linked issues, before/after screenshots, and migration notes if Prisma schema changes.
...
- Prisma uses `DATABASE_URL`; after schema updates run `pnpm db:migrate`.
